...
$(function(){
	//right nav
	$('.right_nav li').live('mouseover',function(){
	...
	//导航四个黑方块
	$('.i_rover').live('click',function(){
		$('.pop_contact').fadeIn();
	});
	//关闭导航四个黑方块
	$('.close_pop_contact').live('click',function(){
		$('.pop_contact').fadeOut();
	});
	
	//普通会员tab
	$('.pt_per_tab_ul li').live('click',function(){
	...
	//帮助中心
	$('.sv_dl_list dt').live('click',function(){
	...
	//发送站内信
	$('.send_site_email_btna').live('click',function(){
		$('#pop_bg').show();
		$('.site_email_pop').show();	
	});

	//填写发货单号
	$('.btn_send_sth').live('click',function(){
		$('#pop_bg').show();
		$('.site_ship_pop').show();	
	});
	
	//上传翻译稿
	$('#upload_fy_word').live('click',function(){
		$('#pop_bg').show();
	...
	//关闭站内信pop
	$('.close_pop_btn,.btna_acancel').live('click',function(){
		$('#pop_bg').hide();
	...
	//商家入驻申请资料认证
	$('.sel_business_users a').live('click',function(){
	...
	//选择服务类别
	$('.sel_sev_style a').live('click',function(){
		_id = $(this).attr('rel');
	...
	$('.xh_po_qx').live('click',function(){
		$('#pop_bg').hide();
		$('.pop_con2').hide();
	});
	
	//回应
	$('.btna_hy_a2').live('click',function(){
		$(this).parent('p').hide();
		$(this).parent().parent().siblings('.my_hy_box').show();
	});
	
	//取消回应
	$('.btn_jy_a4_2').live('click',function(){
		$(this).parent().parent('.my_hy_box').hide();
		$(this).parent().parent().siblings('.my_evaluation_text').children('.mt0').show();
	});
	
	//
	$('.business_detail_img_ulist li img').live('click',function(){
	...
	//删除
	$('.del_btn_p').live('mouseover',function(){
		$(this).children('a').show();
	}).live('mouseout',function(){
		$(this).children('a').hide();
	});
	
	$('.del_btn_p a').live('click',function(){
		_id = $(this).attr('rel');
		_obj = $(this);
		if(_id){
			$.ajax({
	...
	$('.mslist_ul2 li').live('mouseover',function(){
	...
	//删除信息
	$('.talk_del_a').live('click',function(){
		_id = $(this).attr('rel');
		_obj = $(this);
		if(_id){
			$.ajax({
	...
	$('.rn_top').live('click',function(){
		goto('botop');
	});
	
	//帖子详细页回应
	$('.response_btn').live('click',function(){
		$('.hy_box2').hide();
	...
	//首页星级服务商家推荐切换
	$('.star_recommend_tab a').live('click',function(){
	...
	//删除收藏服务 
	$('.del_collection').live('click',function(){
 		_id = $(this).attr('rel');
       showConfirm('是否要删除此收藏？', "delservers("+_id+")");		
	});
	
	//删除收藏商家 
	$('.collection_btndel').live('click',function(){
		_id = $(this).attr('rel');
...
$(function(){
	$('.c_pop_close').live('click',function(){
		$('.com_pop_box').hide();
		$('#pop_bg').hide();
	});
});
